...
def compute_all_metrics(
    ...
    Returns:
        Dict with keys: accuracy, macro_f1, minority_recall, auc_roc, auc_pr, brier_score.
    ...
    rec = recall_score(y_true, y_pred, pos_label=minority_class, zero_division=0)
    ...
    brier = brier_score_loss(y_true, y_prob, pos_label=minority_class)
