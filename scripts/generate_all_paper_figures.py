...
# ==============================================================================
# 1. FIGURE 1: BOLD, HIGH-CONTRAST VECTOR PIPELINE SCHEMATIC
# ==============================================================================
def generate_figure1_schematic():
    ...
    # Row 2: Dynamic Weighting & Invariant Optimization
    ...
    plt.close()
    print("[DONE] Generated Bold, High-Contrast Figure 1 Pipeline Schematic")
